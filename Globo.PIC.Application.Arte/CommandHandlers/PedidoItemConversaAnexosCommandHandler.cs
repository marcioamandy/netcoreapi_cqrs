...
namespace Globo.PIC.Application.Services.Commands
{
		...
		IRequestHandler<SavePedidoItemConversaAnexos>
	{
		...
		protected void RunEntityValidation(PedidoItemConversaAnexos pedidoItem)
		{
			if (pedidoItem == null)
				throw new ApplicationException("O Pedido Item Conversa está vazio!");
		}

		public void RunEntityValidationList(List<PedidoItemConversaAnexos> pedidoItemConversaAnexoViewModels)
		{
