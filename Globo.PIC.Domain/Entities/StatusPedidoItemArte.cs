...
{
    public class StatusPedidoItemArte
    {
        ...
        public virtual IEnumerable<PedidoItemArte> PedidoItensArte { get; set; }
        
        public virtual IEnumerable<PedidoItemArteTracking> Tracking { get; set; }
