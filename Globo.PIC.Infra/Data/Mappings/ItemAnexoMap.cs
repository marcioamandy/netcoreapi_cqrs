...
{
    public class ItemAnexoMap : IEntityTypeConfiguration<ItemAnexo>
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="builder"></param>
        public void Configure(EntityTypeBuilder<ItemAnexo> builder)
        {
            ...
            builder.Property(c => c.DataItemAnexo)
