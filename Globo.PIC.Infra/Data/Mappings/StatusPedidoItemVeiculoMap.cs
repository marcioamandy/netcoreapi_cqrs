...
{
    public class StatusPedidoItemVeiculoMap : IEntityTypeConfiguration<StatusPedidoItemVeiculo>
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="builder"></param>
        public void Configure(EntityTypeBuilder<StatusPedidoItemVeiculo> builder)
        {
            ...
            builder
                .ToTable("TB_STATUS_PEDIDO_ITEM_VEICULO")
                .HasKey(c => c.Id);
