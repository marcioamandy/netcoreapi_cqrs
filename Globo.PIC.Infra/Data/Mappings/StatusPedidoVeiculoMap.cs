...
{
    public class StatusPedidoVeiculoMap : IEntityTypeConfiguration<StatusPedidoVeiculo>
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="builder"></param>
        public void Configure(EntityTypeBuilder<StatusPedidoVeiculo> builder)
        {
            ...
            builder
                .ToTable("TB_STATUS_PEDIDO_VEICULO")
                .HasKey(c => c.Id);
